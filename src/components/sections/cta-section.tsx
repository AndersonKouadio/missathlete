          ...
          <div className="inset-0 flex flex-col items-center justify-center px-6 md:px-12 py-12">
            <div className="max-w-3xl w-full text-center space-y-8">
              ...
              <p className="text-white/95 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
                Contactez l'initiatrice du projet, <span className="font-bold">Cynthia Kragbé</span>, pour toute question de partenariat, de média ou d'information générale.
              </p>

              {/* Coordonnées */}
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 space-y-4 border border-white/20">
                <h3 className="text-white text-xl md:text-2xl font-bold mb-6">Coordonnées</h3>
              ...
              <div className="space-y-4">
                <h4 className="text-white text-lg md:text-xl font-semibold">Suivez-nous</h4>
